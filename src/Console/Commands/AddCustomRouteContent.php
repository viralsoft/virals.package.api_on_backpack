...
class AddCustomRouteContent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'backpack-api:add-custom-route
     ...
     * @var string
     */
    protected $description = 'Add HTML/PHP code to the routes/backpack/api.php file';
    ...
    public function handle()
    {
        ...
        if ($disk->exists($path)) {
            ...
            $command = 'php artisan vendor:publish --provider="ViralsBackpack\BackPackAPI\BackPackAPIServiceProvider" --tag=custom_routes';
